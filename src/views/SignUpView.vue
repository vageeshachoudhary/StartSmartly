<template>
    ...
    <div id="signuppage">
        ...
        <form @submit.prevent="signup">
            ...
            <div id="firstname" class="form-group" :class="{ 'error': errors.firstName }">
            ...
            <div id="confirmpassword" class="form-group" :class="{ 'error': errors.confirmPassword }">
...
export default class SignUpView extends Vue {
    ...
    signup() {
        ...
        if (Object.keys(this.errors).length === 0) {
            this.$router.push('/'); // Redirect to home page after successful signup
        }
    }
